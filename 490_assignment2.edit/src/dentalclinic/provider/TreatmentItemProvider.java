...
/**
 * This is the item provider adapter for a {@link dentalclinic.Treatment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TreatmentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Treatment_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Treatment_name_feature", "_UI_Treatment_type"),
				 DentalclinicPackage.Literals.TREATMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPricePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Treatment_price_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Treatment_price_feature", "_UI_Treatment_type"),
				 DentalclinicPackage.Literals.TREATMENT__PRICE,
				 true,
				 false,
				 false,
	...
	protected void addTimeSlotsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Treatment_timeSlots_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Treatment_timeSlots_feature", "_UI_Treatment_type"),
				 DentalclinicPackage.Literals.TREATMENT__TIME_SLOTS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DentalclinicPackage.Literals.TREATMENT__PRODUCT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DentalclinicPackage.Literals.TREATMENT__PRODUCT,
